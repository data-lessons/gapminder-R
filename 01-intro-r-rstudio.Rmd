...
Don't need to remember. Can use google or tab-completion.
...
*Demo how to unpack this*

```{r}
logOfX <- log(x, base = 10)
isLogXGreaterThanOne <- logOfX > 1
isLogXGreaterThanOne
```

> #### Challenge -- Variable Assignment {.challenge}
>
