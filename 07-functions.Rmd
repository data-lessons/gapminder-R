...
- Collapse the data to one exchange rate per country



- Get all the exchange rates. You can [download that here](https://raw.githubusercontent.com/michaellevy/gapminder-R/gh-pages/data/exchange_rate.csv).
